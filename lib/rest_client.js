...
module.exports.RestClient = function (options) {
    ...
    function apiCall(request_data, request_token = '') {
        /* eslint no-undef: off*/
        var oauthHeader = oauth.toHeader(oauth.authorize(request_data, token));
        var oauthHeaderWithCountry = Object.assign({}, oauthHeader, {'country-id': country});
        return new Promise(function (resolve, reject) {
            request({
                url: request_data.url,
                method: request_data.method,
                headers: request_token ? { 'Authorization': 'Bearer ' + request_token, 'country-id': country } : oauthHeaderWithCountry,
                json: true,
